...
if(strpos($_SERVER['REQUEST_URI'], 'success') !== false){
    echo "<p style='color:green;'>Er is een e-mail verzonden naar $_SESSION[email], klik op de link in de e-mail om door te gaan.</p>";
}
?>

            <form class="m-t" role="form" action="includes/loginpatient.inc.php" method="POST">
